...
from crossmodal.position_embedding import SinusoidalPositionalEmbedding
from crossmodal.multihead_attention import MultiheadAttention
import math
...
if __name__ == '__main__':
    t = torch.randn((50, 48, 768))
    a = torch.randn((50, 48, 48))
    v = torch.randn((50, 48, 48))
    encoder = TransformerEncoder(768, 16, 6)
    print(encoder(t, t, t).shape)
